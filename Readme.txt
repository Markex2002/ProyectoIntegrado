...
Con todo esto hecho, solo quedaria iniciar el PreProyectoAplication, tambien, para cargar nuestra base de datos con entidades, ejecutaremos el test
que se encuentra en tests/java/ApiRestPreProyectoAplication.

Por ultimo dirigete al FrontEnd, ejecuta npm install, y cuando este listo, ng serve.
Con eso nuestro proyecto estara listo y operativo.
